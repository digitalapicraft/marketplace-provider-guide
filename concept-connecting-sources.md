...
A source is any system Astra reads API definitions from. Connecting sources is how the catalog fills up: you point Astra at the gateways and repositories where your APIs already live, and it brings those definitions in. This page explains what a source is and why connections are read-only by design.
...
Astra recognises two kinds of source.
...
Out of the box, Astra connects to a broad set of systems:
